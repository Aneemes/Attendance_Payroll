                    ...
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          ...
                          <td>
                            <button class='edit edit-btn' data-id='".$row['caid']."'><i class='fa fa-edit'></i> Edit</button>
                            <button class='delete delete-btn' data-id='".$row['caid']."'><i class='fa fa-trash'></i> Delete</button>
                          </td>
                        </tr>
                      ";
                    }
