...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h4>
        <button type="button" class="payroll-btn" id="payroll"><span class="glyphicon glyphicon-print"></span> Payroll</button>
        <button type="button" class="payslip-btn" id="payslip"><span class="glyphicon glyphicon-print"></span> Payslip</button>
      </h4>
    </section>
    <!-- Main content -->
          ...
          <div class="box">
            <div class="box-header with-border">
              <div class="pull-right">
                <form method="POST" class="form-flex" id="payForm">
